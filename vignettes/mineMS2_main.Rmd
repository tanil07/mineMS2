...
plotPatterns(pnordicum.msl, phe_pattern.c)
```

These results can be exported in pdf (one pdf file per pattern) by setting the `save_dir` argument to the path of the directory to save the files (default to `"none"` for no export).
