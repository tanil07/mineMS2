...
//    kt.to_string(Rcpp::Rcerr);
    ...
    for(auto it=initialPatterns.begin();it!=initialPatterns.end();it++){
        ...
        while(counter<LIM_ITER){
            //We always consider the last elemnt of the stack.
            lattice_node& current_node = lattice_stack.top();
//            current_node.to_reduced_string(Rcpp::Rcerr);
//            Rcpp::Rcerr<<"\n";
...
//                            Rcpp::Rcerr << "after_complete: ";
//                            for(; ba!= ea; ba++){
//                                Rcpp::Rcerr << gg[*ba].lab << " ";
//                            }
//                            Rcpp::Rcerr << std::endl;
//                            Rcpp::Rcerr << "after_complete edge: ";
//                            for(; bo!= eo; bo++){
//                                Rcpp::Rcerr << gg[*bo].lab << " ";
//                            }
//                            Rcpp::Rcerr << std::endl;
                            counter++;
...
//                            Rcpp::Rcerr << " out " << std::endl;
    ...
    Rcpp::Rcerr<<insert_error<<" errors of insertion."<<std::endl;
    Rcpp::Rcerr<<"Explored "<< counv<<" graphs. "<<container.numSubgraphs()<<" closed frequent subgraphs found."<<
